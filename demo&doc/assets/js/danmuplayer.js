	...
	$.extend(Tooltip.prototype, {
		show: function(allowMirror) {
			...
			if (this.options.position === 'w') {
				...
				tooltipBox.left = targetBox.left - Math.floor((tooltipBox.width - targetBox.width) / 2)-$("#danmu").offset().left;
				tooltipBox.top = targetBox.top-tooltipBox.height-pointerBox.height-$("#danmu").offset().top
		...
		danmu_video = videojs("#danmu_video", {
			...
			function initer() {
				...
				this.on('play', function(e) {
					...
					$('#danmu').data("nowtime", parseInt(danmu_video.currentTime() * 10));
				...
				this.on('seeked', function(e) {
					...
					$('#danmu').data("nowtime", parseInt(this.currentTime() * 10));
				});
			}
			...
			$("body").append("<div id='tip2' hidden='true'><form  id='danmu_position'>弹幕位置：<input type='radio' checked='checked'  name='danmu_position' value='0' />滚动&nbsp;&nbsp;<input type='radio' name='danmu_position' value='1' />顶端&nbsp;&nbsp;<input type='radio' name='danmu_position' value='2' />底端&nbsp;&nbsp;</form><form  id='danmu_size' >弹幕大小：<input   type='radio' checked='checked'  name='danmu_size' value='1' />大文字&nbsp;&nbsp;<input   type='radio' n name='danmu_size' value='0' />小文子&nbsp;&nbsp;</form>弹幕颜色：<br><div id='danmu_color' /></div></div><div id='tip22' hidden='true'>透明度：<input type='range' name='op' id='op' onchange='op()' value=100 ><br>显示弹幕:<input type='checkbox' checked='checked' id='ishide' value='is' onchange='changehide()'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;循环播放:<input type='checkbox' id='isloop' value='is' onchange='changeloop()'> </div> ");

			$(".vjs-control-bar").append('<span class="shezhi tooltips">(&gt;^ω^&lt;)</span>');
			...
			$(".vjs-control-bar").append('<span id="shi" class="shezhi tooltips2 vjs-menu-button"  > 視 </span>');
